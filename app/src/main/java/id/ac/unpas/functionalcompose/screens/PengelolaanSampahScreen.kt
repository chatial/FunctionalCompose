            ...
            items(items = items, itemContent = { item ->
                Row(modifier = Modifier
                    ...
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Tanggal_beli", fontSize = 14.sp)
                        Text(text = item.Tanggal_beli, fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Nama_Pembeli", fontSize = 14.sp)
                        Text(text = item.Nama_Pembeli, fontSize = 16.sp, fontWeight =
                        FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Merek_sepatu", fontSize = 14.sp)
                        Text(text = item. Merek_sepatu, fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Notelephone", fontSize = 14.sp)
                        Text(text = "+62${item.Notelephone} ", fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                }
